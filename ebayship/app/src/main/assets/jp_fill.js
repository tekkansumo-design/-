...
//
// このサイトは公開 API が無く、入力欄はログインの内側にあるので、id を
// こちらで決め打ちにはできない。代わりに「入力欄に付いているラベルの文言」と
// 「その欄がお届け先とご依頼主のどちらの区画にあるか」から項目を推測して入れる。
// 外れる画面は呼び出し側の学習機能でセレクタを覚えさせ、次回はそれを優先する。
//
// Android 版は assets から、PC 版はこのファイルを直接読む。
// 二重に持つと必ずずれるので、実体はここ 1 つだけ。
(function () {
